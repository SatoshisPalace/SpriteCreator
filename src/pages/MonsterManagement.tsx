...
const MonsterManagement: React.FC = () => {
  ...
  const handlePlayMonster = async () => {
    ...
    const isPlaytime = walletStatus.monster.status.type === 'Playing';
  ...
  const renderMonsterCard = () => {
    ...
    const isPlaytime = monster.status.type === 'Playing';
            ...
            <div className="col-span-2">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
                  ...
                  style={{ width: `${(monster.exp / getFibonacciExp(monster.level)) * 100}%` }}
                ></div>
              </div>
            </div>
